...
area, perimeter, string representations,
and prints a message when instance is deleted.
"""
...
class Rectangle:
    ...
    validating inputs and supporting area, perimeter,
    string representation, repr, and deletion message.
    """
