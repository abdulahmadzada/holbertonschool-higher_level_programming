...
counting instances, string representation and utility methods.
"""
...
class Rectangle:
    ...
    counting instances, print symbol, and several methods.
    """
    ...
    def __str__(self):
        """Return the rectangle as a string with the print_symbol."""
        if self.__width == 0 or self.__height == 0:
            return ""
    ...
    def __repr__(self):
        """Return a string to recreate the instance via eval()."""
    ...
    def square(cls, size=0):
        ...
        Returns:
            Rectangle: New Rectangle instance with equal sides.
        """
